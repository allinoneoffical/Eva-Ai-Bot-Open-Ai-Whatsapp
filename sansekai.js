 ...
 *(Text to Image)
 ...
 Create an image from text`)
          break;
        case "ai": case "openai": case "eva": case "ask": 
          try {
            if (setting.keyopenai === "ISI_APIKEY_OPENAI_DISINI") return reply("Apikey hasn't been filled\n\nSilahkan isi terlebih dahulu apikeynya di file key.json\n\nApikeynya bisa dibuat di website: https://beta.openai.com/account/api-keys");
            if (!text) return reply(`Ask me anything buddy😕.\n\nExample:\n${prefix}${command} How are you Eva🥰`);
        ...
        case "img": case "ai-img": case "image": case "images":
          try {
            if (setting.keyopenai === "ISI_APIKEY_OPENAI_DISINI") return reply("Apikey hasn't been filled\n\nPlease fill in the apikey in the file key first.json\n\nApikey can be created on the website: https://beta.openai.com/account/api-keys");
